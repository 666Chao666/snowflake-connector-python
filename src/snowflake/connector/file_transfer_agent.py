...
class SnowflakeFileMeta:
    ...
    client_meta: Optional['SFResourceMeta'] = None
...
class SFResourceMeta:
    storage_client: Optional[Type[Union['SnowflakeRemoteStorageUtil', 'SnowflakeLocalUtil']]] = None
    stage_info: Optional[Dict[str, Any]] = field(default_factory=dict)
